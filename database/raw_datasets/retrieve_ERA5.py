...
for years in years_wanted:
    ...
    variables_wanted    = ['10m_u_component_of_wind','10m_v_component_of_wind', '2m_temperature', 'sea_ice_cover', 'sea_surface_temperature', 'mean_surface_net_short_wave_radiation_flux', 'mean_surface_net_long_wave_radiation_flux', 'mean_surface_latent_heat_flux', 'sea_surface_temperature', 'snow_depth', 'soil_temperature_level_1', 'soil_temperature_level_2', 'soil_temperature_level_3', 'soil_temperature_level_4']
    ...
    for variables_now in variables_wanted:
        ...
        c.retrieve('reanalysis-era5-single-levels', {
                ...
                'area'          : [69, 205, 72, 210],      # North, West, South, East. Default: global
